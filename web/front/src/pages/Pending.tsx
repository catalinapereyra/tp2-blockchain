...
export default function Pending() {
  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        <div style={{ ...s.iconWrap, background: isRevoked ? "#fef2f2" : "#fffbeb" }}>
          {isRevoked ? (
        ...
        <h2 style={{ ...s.title, color: isRevoked ? "#dc2626" : "#0f172a" }}>
...
const s: Record<string, React.CSSProperties> = {
  ...
  text: { color: "#64748b", lineHeight: 1.6, fontSize: 14, margin: 0, maxWidth: 320 },
  wallet: { fontSize: 11, color: "#94a3b8", fontFamily: "monospace", margin: 0, wordBreak: "break-all" as const },
  btn: {
    marginTop: 8, background: "#6366f1", color: "white", border: "none",
